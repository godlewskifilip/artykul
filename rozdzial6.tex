...
Do wykonania tego zadania użyłem klasy report, ponieważ umożliwia
tworzenie dokumentu składającego się z wielu rozdziałów, wspiera
elementy wymagane w zadaniu (tabele, ilustracje, bibliografię, itp.)
oraz nie wprowadza nadmiarowych funkcji charakterystycznych dla klasy
book, które są zbędne w tego typu pracy.
https://github.com/godlewskifilip/artykul/tree/main
